<template>
  <div class="container">
          ...
          <tr v-if="parent.showChildren">
            <td>
              <div class="staff-left">
                <table>
                  <tbody>
                    <tr v-for="staff in staffChildren" :key="staff.left.id">
                      <td>
              ...
              <div class="staff-right">
                <table>
                  <tbody>
                    <tr v-for="staff in staffChildren" :key="staff.left.id">
                      <td v-if="staff.right">
                        <show-dept :parent="staff.right" :level="level + 1" />
                      </td>
                    </tr>
                  </tbody>
                </table>
    ...
    <table class="tabchildren">
      <tbody>
        <tr v-if="parent.showChildren">
          <td v-for="child in hierarchyChildren" :key="child.id" class="tabchild">
